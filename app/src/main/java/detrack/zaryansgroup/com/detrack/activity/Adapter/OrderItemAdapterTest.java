...
public class OrderItemAdapterTest extends RecyclerView.Adapter<OrderItemAdapterTest.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.tvPcsPrice.setText(String.valueOf((int) model.getRetailPiecePrice()));
        ...
        int totalAmount = 0;
        int pcsTotal = model.getPcs_qty() * (int) model.getRetailPiecePrice();
        ...
        if(model.getTaxCode().equalsIgnoreCase("3rd")){
            ctnTotal = model.getCtn_qty() * (int) model.getWSCtnPrice();
            holder.tvCtnPrice.setText(String.valueOf((int) model.getWSCtnPrice()));
        }else {
