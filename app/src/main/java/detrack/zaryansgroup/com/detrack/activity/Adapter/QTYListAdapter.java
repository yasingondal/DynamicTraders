...
public class QTYListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (deliveryStatus.equals("Booking")) {
            ...
            item_pcs_price_total.setText(String.valueOf(model.getPcs_qty() * model.getRetailPiecePrice()));
            ...
            item_pcs_price_total.setText(String.valueOf(model.getDeliver_pcs_qty() * model.getRetailPiecePrice()));
        }
        ...
        item_pieces_Retail_price.setText(String.valueOf(model.getRetailPiecePrice()));
