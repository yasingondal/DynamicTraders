...
//        return view;
        ...
        tvItemPrice.setText(String.valueOf((float) model.getRetailPiecePrice()));
        tvItemQty.setText(String.valueOf(model.getPcs_qty()));
        tvItemAmount.setText(model.getPcs_qty() * (float)model.getRetailPiecePrice() + "");
    ...
    private void SetPriceDialog(final int postion){
        ...
        picesPriceET.setText(list.get(postion).getRetailPiecePrice() + "");
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (crtnPrice != 0 && packPrice != 0 && picesPrice != 0) {
                        ...
                        list.get(postion).setRetailPiecePrice(picesPrice);
