...
public class ZEDTrackDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            //FetchBankDetails Assignment Work by MY on 8 sep 2021
    ...
    public void dropTablesOnLogout(){
    ...
    public void CreateTablesOnLogout(){
        SQLiteDatabase db = this.getWritableDatabase();
...
//    public void dropRuntimeBankTables(){
//
//        SQLiteDatabase db = this.getWritableDatabase();
//        //Work By Yaseen
//        db.execSQL(DBHelper.DROP_TABLE_TBL_COMPANY_WISE_BANKS);
//        Log.d("banktabledropper", "true");
//    }

    public void CreateRuntimeBankTables() {

        SQLiteDatabase db = this.getWritableDatabase();
        //Work By Yaseen
        db.execSQL(DBHelper.CREATE_TABLE_TBL_COMPANY_WISE_BANKS);
        Log.d("banktablecreated", "true");
    }
    ...
    public int insertCompanyWiseBankDetails(ArrayList<CompanyWiseBanksModel> list) {
        ...
        try {
            for (int i = 0; i < list.size(); i++) {
                ...
                //CheckPoint
                Log.d("offlineinsertionbanks", "true");
...
//                } else {
                ...
                values.put(DBHelper.ORDER_CONFIRM_CHILD_WHOLESALE_CTN_PRICE, model.getWSCtnPrice());
                ...
                values.put(DBHelper.ORDER_CONFIRM_CHILD_RETAIL_PIECES_PRICE, model.getRetailPiecePrice());
    ...
    public ArrayList<DeliveryItemModel> getSQLiteOrderDeliveryItems(String delivery_id, String IsNew, boolean forclosing) {
        ...
        try {
            ...
            if (forclosing) {
                ...
                Timber.d("Select * from" + DBHelper.TBL_ORDER_CONFIRM_CHILD + "Where" + DBHelper.ORDER_CONFIRM_MASTER_DETAIL_ID + " = " + Integer.parseInt(delivery_id));
            } else {
            ...
            Log.d("getOrderQuery", "select * from " + DBHelper.TBL_ORDER_CONFIRM_CHILD + " Where " + DBHelper.ITEM_DELIVERY_ID + " = " + Integer.parseInt(delivery_id));
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    model.setWSCtnPrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.ORDER_CONFIRM_CHILD_WHOLESALE_CTN_PRICE)));
                    ...
                    model.setRetailPiecePrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.ORDER_CONFIRM_CHILD_RETAIL_PIECES_PRICE)));
...
//            }
    ...
    public int UpdateSynChanges(int id) {
        Utility.logCatMsg("Sqlite UpdateSynChanges " + id);
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<DeliveryItemModel> getAllItems() {
        ...
        if (cursor != null) {
            ...
            while (cursor.moveToNext()) {
                ...
                model.setWSCtnPrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.ITEM_PRICE_WS_CORTON)));
                ...
                model.setRetailPiecePrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.ITEM_PRICE_RETAIL_PIECES)));
    ...
    public void insertRunTimeOrderDetails(ArrayList<DeliveryItemModel> list, RegisterdCustomerModel RS_model, String isUrgent) {
        ...
        try {
            for (int i = 0; i < list.size(); i++) {
                ...
                Utility.logCatMsg("GST vale " + i + "" + model.getItemGstValue());
                ...
                if (model.getSelectedValue() != null)
                    if (!model.getSelectedValue().equals("0")) {
                        ...
                        if (RS_model.getServerOrderId() != 0) {
                            ...
                            Utility.logCatMsg("insetruntime -sitemid " + RS_model.getServerOrderId());
                        } else {
                            ...
                            Utility.logCatMsg("insetruntime -oitemid " + RS_model.getServerOrderId());
                        }


//                    values.put(DBHelper.ORDER_CONFIRM_CHILD_SERVER_DETAIL_ID, 0);
                        values.put(DBHelper.ORDER_CONFIRM_CHILD_SERVER_DETAIL_ID, model.getServer_Item_Id());
                        values.put(DBHelper.ORDER_CONFIRM_CHILD_ITEM_NAME, model.getName());
                        values.put(DBHelper.ORDER_CONFIRM_CHILD_ITEM_ID, model.getItem_id());

                        values.put(DBHelper.ORDER_CONFIRM_CHILD_COST_CTN_PRICE, Math.abs(model.getCostCtnPrice()));
                        values.put(DBHelper.ORDER_CONFIRM_CHILD_WHOLESALE_CTN_PRICE, Math.abs(model.getWSCtnPrice()));
                        ...
                        values.put(DBHelper.ORDER_CONFIRM_CHILD_RETAIL_PIECES_PRICE, Math.abs(model.getRetailPiecePrice()));
        ...
        try {
            ...
            //values.put(DBHelper.ORDER_TOTAL_QTY, Total_Quantity);
            values.put(DBHelper.ORDER_DELIVERY_DATE, RS_model.getDate());
            ...
            values.put(DBHelper.ORDER_DATE_TIME, RS_model.getDate());
    ...
    public ArrayList<DeliveryItemModel> getCompanyItem() {
        ...
        try {
            Utility.logCatMsg("SQLite code ");
            Cursor cursor = database.rawQuery("select * from " + DBHelper.TBL_PLN_ITEMS, null);
            if (cursor != null) {
                ArrayList<DeliveryItemModel> list = new ArrayList<>();
                while (cursor.moveToNext()) {
                    DeliveryItemModel model = new DeliveryItemModel();
    ...
    public void insertCompanyItem(ArrayList<DeliveryItemModel> list) {
        ...
        try {
            for (int i = 0; i < list.size(); i++) {
                ...
                values.put(DBHelper.ITEM_PRICE_WS_CORTON, model.getWSCtnPrice());
                ...
                values.put(DBHelper.ITEM_PRICE_RETAIL_PIECES, model.getRetailPiecePrice());
...
//                    Log.d("emptyFlag", model.getEmptyFlag());
    ...
    public CompanyWiseBanksModel getDelieveryOrderBankInfo(int cashDepositedBankId) {
        ...
        try {
            ...
            Log.d("sqldbquery", "select * from " + DBHelper.TBL_COMPANY_WISE_BANKS + " Where " +
                    DBHelper.BANK_ID + " = " + cashDepositedBankId);
//
...
//
    ...
    public int CollectCashDepositedBankId(String delivery_id) {
        ...
        try {
            ...
            Log.d("sqldbankidquery", "select " + DBHelper.ORDER_CASH_DEPOSITED_BANK_ID + " From " +
                    DBHelper.TBL_ORDER_CONFIRM_MASTER + " where " + DBHelper.ORDER_CONFIRM_MASTER_ID + "=" + Integer.parseInt(delivery_id));
        ...
        try {
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    model.setPrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.ORDER_CONFIRM_CHILD_RETAIL_PIECES_PRICE)));
                    model.setTotalRetailPrice(cursor.getFloat(cursor.getColumnIndex(DBHelper.
                            ORDER_CONFIRM_CHILD_TOTAL_RETAIL)));
