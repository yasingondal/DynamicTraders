...
public class ItemsListActivity extends AppCompatActivity {
   ...
   public static String orderStatus = "";
    ...
    private void InitilizeAlaram() {
        Intent intent = new Intent(ItemsListActivity.this, GPSService.class);
        pintent = PendingIntent.getService(ItemsListActivity.this, 0, intent, 0);
    ...
    private void SelectQuantityDiloge(final int postion) {
        ...
        etPiecePrice.setText(String.valueOf(list.get(postion).getRetailPiecePrice()));
