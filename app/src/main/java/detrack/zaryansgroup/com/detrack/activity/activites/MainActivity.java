...
public class MainActivity extends AppCompatActivity implements TabActivity.SendMultipleSelectionEventToPlaindOrderActivity {

    ListView dilervyJobListView, menuList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new ZEDTrackDB(MainActivity.this);
        ...
        newOrderFileDilog = new ProgressDialog(MainActivity.this);
        ...
        dilervyJobListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cb.getVisibility() == View.VISIBLE) {
                    ...
                    Intent intent = new Intent(MainActivity.this, POD_DashBoard.class);
//                    Log.d("delivery_id", model.getServer_Delivery_id() + "    " + model.getDelivery_id());

                    BankId = model.getCashDespositedBankId();
                    Log.d("deliveryid","id="+model.getServer_Delivery_id());
                    Log.d("assignorderbankid","="+model.getCashDespositedBankId());
//                    Log.d("BankId","=>"+model.getCashDespositedBankId());
                    intent.putExtra("Delivery_id", model.getServer_Delivery_id() + "");
        ...
        deleteIV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (check) {
                    Utility.Toast(MainActivity.this, "Planned Order can't be delete");
                    multipleSelectionLL.setVisibility(View.GONE);
                    mSearchEt.setVisibility(View.VISIBLE);
                    listAdapter.isChecked(false);
                    listAdapter.notifyDataSetChanged();
...
*/
                ...
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (ConnectionDetector.isConnectingToInternet(MainActivity.this)) {
                            ...
                            SendPod sp = new SendPod(MainActivity.this, "False", deliveryIdList);
                            sp.SaveChangesToDataBase();
                            dialog.cancel();
                            onResume();
                        } else {
                            Utility.Toast(MainActivity.this, "Check network connection and try again");
                        }
                    }
                })
    ...
    private class SearchWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            dilervyJobListView.setAdapter(new DeliveryListAdapter(MainActivity.this, filteredList));
        }
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (tableArray.length() > 0) {
                        ...
                        getJobItem(Utility.BASE_LIVE_URL+"api/Job/GetTodayJobItems?Delivery_id=" + allDelivery_id);
                        Log.d("itemUrl", Utility.BASE_LIVE_URL+"api/Job/GetTodayJobItems?Delivery_id=" + allDelivery_id);
                    }
        ...
        try {
            ...
            for (int i = 0; i < feedArray.length(); i++) {
             ...
             /*   model.setDelivery_start_time(feedObj.getString("Start_time"));
                ...
                model.setGst(String.valueOf(feedObj.getInt("GSTValue")));
                Log.d("gstvalue","="+feedObj.getString("NetTotal"));
                feedItems.add(model);
            }
        } catch (JSONException e) {
            e.printStackTrace();
    ...
    private void parseJsonFeedItems(JSONArray feedArray) {
        ...
        if (feedItems.size() > 0) {
            ...
            Utility.Toast(MainActivity.this, "No Job Available Today");
        }
    }
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (ConnectionDetector.isConnectingToInternet(MainActivity.this)) {
                            ...
                            parameters.add(p1);
//                            getTodayJob(Utility.BASE_LIVE_URL+"Job/GetTodayJob?TrackingNo=" + prefs.getEmployeeID());
                            Log.d("JobUrl", Utility.BASE_LIVE_URL+"api/Job/GetTodayJob?TrackingNo=" + prefs.getEmployeeID());
        ...
        builder.setItems(optionlist, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                if (optionlist[item].equals("Cancel")) {
                    ...
                    Intent in = new Intent(MainActivity.this, AddImages.class);
                    ...
                    if (list.get(pos).getIsPod_sync().toString().equals("2")) {
                        Utility.Toast(MainActivity.this, "Cannot do this action Order is sent to server");
                    } else {
                        if (list.get(pos).getDelivery_status().equals("Delivered")) {
                            Utility.Toast(MainActivity.this, "Order status is already delivered");
                        }
                        else {
                            ...
                            if (gps.canGetLocation()) {
                                ...
                                if (latitude > 0.0) {
                                    ...
                                    Toast.makeText(MainActivity.this, "Location not found...try again", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                gps.showSettingsAlert();
                            }
                    ...
                    if (list.get(pos).getIsPod_sync().toString().equals("2")) {
                        Utility.Toast(MainActivity.this, "Job Already Sent.");
                    } else {
                        if (!list.get(pos).getDelivery_status().equals("Inprogress")) {
                            ...
                            Utility.Toast(MainActivity.this, "Change order status first.");
                        }
                    }
                }
            }
