...
public class POD_DashBoard extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView Order_addressTV, ServerOrderSatusTV, Order_To_nameTV, OrderSatusTV, Order_timeTV,
            InstructionTV, totalbill, perdiscount, net_total, latlngTV, tvGSt;
    ...
    private void InitilizeAlaram() {
        Intent intent = new Intent(POD_DashBoard.this, GPSService.class);
        pintent = PendingIntent.getService(POD_DashBoard.this, 0, intent, 0);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.discount_btn:
                ...
                break;
            case R.id.itemBtn: {
//                Intent i = new Intent(POD_DashBoard.this, ItemsListActivity.class);
//                // i.putExtra("status_id",feedItems.get(position).getStatusId());
//                if(deliverInfo.getDelivery_status().equals("Returned")){
//
//                    i.putExtra("orderStatus", "Returned");
//                }
//                else{
//                    i.putExtra("orderStatus","Delivered");
//                }
//                i.putExtra("Delivery_id", deliverInfo.getDelivery_id() + "");
...
//                startActivity(i);
                if ((deliverInfo.getDelivery_status().equals("Delivered") ||
                    ...
                    if (new SharedPrefs(POD_DashBoard.this).getView().equals("secondView")) {
                        startActivity(new Intent(POD_DashBoard.this, SelectProductActivitySecond.class)
                                .putExtra("addOrder","update")
                                .putExtra("deliverInfo",deliverInfo)
...
//                        deliverInfo.setNetTotal(netTotal + "");
