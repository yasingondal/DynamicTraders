...
public class SelectCustomerActivity extends AppCompatActivity {
    ...
    ZEDTrackDB db;
    RegisterdCustomerModel model, startModel;
    TextView actionbar;
    ImageButton btnMenu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSelectCustomer_viewModel = new ViewModelProvider(this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(this.getApplication())).get(SelectCustomer_ViewModel.class);
    ...
    private void InitilizeAlaram() {
        Intent intent = new Intent(SelectCustomerActivity.this, GPSService.class);
        pintent = PendingIntent.getService(SelectCustomerActivity.this, 0, intent, 0);
    ...
    private void initializeWidgets() {
        ...
        Log.d("updateLocation", String.valueOf(updateLocation));
                ...
                if(updateLocation){
                    ...
                    if(!cbSetLocation.isChecked()){
                        ...
                        if(ConnectionDetector.isConnectingToInternet(SelectCustomerActivity.this)){
                            if(!(model.getCustomer_id() >0)){
                                Toast.makeText(SelectCustomerActivity.this, "select customer first", Toast.LENGTH_SHORT).show();
                            }
                            else{
//                                updateCustomerLocation();
                                updateCustomerLocation(Utility.BASE_LIVE_URL+"api/customer/updateCustomerLatLong?CustomerId="+model.getCustomer_id()+"&Longitude="+lng+"&Latitude="+lat);
//                                Log.d("updateLocationUrl","http://deliveryapi.zederp.net/api/customer/updateCustomerLatLong?CustomerId="+model.getCustomer_id()+"&Longitude="+lng+"&Latitude="+lat);
                    ...
                    if (!tvCustomerName.getText().toString().equals("")) {
                        if(sharedPrefs.getView().equals("secondView")){
                            ...
                            intent.putExtra("selectedCustomer", model);
...
//                });
        ...
        StringRequest request = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.d("updateLocationResponse",response);
    ...
    private void SpinnersListner() {
        ...
        spCustomerName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(model.getName().equals("Select Customer")){
