...
public class SendPod {
    ...
    private HashMap<String, String> GetPODDataParamList() {
        ...
        String OrderDetailIdList = "", FOCQtyList = "", FOCValueList = "", FOCPercentageList = "", DiscountList = "", TotalQuantityList = "",
                ...
                NetAmountList = "", GSTPercentageList = "", GSTValueList = "", DisplayPriceList = "", ItemIdList = "", CostCtnPriceList = "", CostPackPriceList = "", CostPiecePriceList = "", WSPiecePriceList = "", WSPackPriceList = "", WSCtnPriceList = "", RetailPiecePriceList = "", RetailCtnPriceList = "", RetailPackPriceList = "", EmptyBottleList = "", CategoryIdList = "", RouteId = "";
    ...
    private void SaveOrder(String Delivery_id) {
        ...
        paramsMap.put("TotalQuanityList", TotalQuanityList);
        paramsMap.put("TotalCostList", TotalCostList);
        ...
        if (deliverInfo.getFromserver().equalsIgnoreCase("1")) {
            ...
            if (deliverInfo.getDelivery_status().equals("Returned")) {
                ...
                Observable<String> hResponseObservable = Api_Reto.getRetrofit().getRetrofit_services().hMakeNewOrder(hSaleReturnUrl);
                ...
                progressDialog.show();
                api = "api/Order/V1addNewOrder";
                String rAddNewSaleOrder = Utility.BASE_LIVE_URL + api + "?EmployeeId=" + paramsMap.get("EmployeeId") +
                        "&CustomerId=" + paramsMap.get("CustomerId") + "&VehicleId=" + paramsMap.get("VehicleId") +
                ...
                Observable<String> hResponseObservable = Api_Reto.getRetrofit().getRetrofit_services().hMakeNewOrder(rAddNewSaleOrder);
                CompositeDisposable hCompositeDisposable = new CompositeDisposable();
...
//    }
    ...
    private void updateOrder() {
        ...
        progressDialog.show();
        Api_Reto.getRetrofit().getRetrofit_services().updateOrder(GetPODDataParamList())
